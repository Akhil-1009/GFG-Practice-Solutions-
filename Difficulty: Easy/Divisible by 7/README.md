<h2><a href="https://www.geeksforgeeks.org/problems/divisible-by-73224/1?page=1&sortBy=difficulty">Divisible by 7</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:20px">Given an n-digit large number in form of string, check whether it is divisible by 7 or not.&nbsp;</span><span style="font-size:18px">Print 1&nbsp;if divisible by 7, otherwise 0.</span></p>
